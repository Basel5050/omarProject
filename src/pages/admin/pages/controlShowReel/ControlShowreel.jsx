...
const ControlShowReel = () => {
      const videoShowReel = import.meta.env.VITE_SHOWREEL_URL ;
        ...
        {showreelLoading ? (
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full bg-white border rounded shadow">
              ...
              <tbody>
                {Array.isArray(showreelLink) && showreelLink.map((video) => (
...
export default ControlShowReel